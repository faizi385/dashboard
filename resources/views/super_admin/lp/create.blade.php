        ...
        <form id="createLpForm" action="{{ route('lp.store') }}" method="POST">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="dba" id="dba" class="form-control @error('dba') is-invalid @enderror">
                    @error('dba')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="email" name="primary_contact_email" id="primary_contact_email" class="form-control @error('primary_contact_email') is-invalid @enderror">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="primary_contact_phone" id="primary_contact_phone" class="form-control @error('primary_contact_phone') is-invalid @enderror">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="primary_contact_position" id="primary_contact_position" class="form-control @error('primary_contact_position') is-invalid @enderror">
