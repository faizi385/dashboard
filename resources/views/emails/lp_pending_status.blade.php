...
<head>
    ...
    <title>LP Status Pending</title>
</head>
<body>
    <p>Dear {{ $lpName }},</p>

    <p>Thank you for registering as a License Producer(LP) with us. Your registration status is currently <strong>pending</strong>.</p>
