...
class CovaDiagnosticReportImport implements ToModel, WithHeadingRow
{
    ...
    public function model(array $row)
    {
        ...
        if ($report->province == 'MB' || $report->province == 'Manitoba' || $report->province == 'BC' || $report->province == 'British Columbia') {
            if ($row['new_brunswick_sku'] != null || $row['product_name'] != null || $row['manitoba_barcode_upc'] != null) {
                if (($row['new_brunswick_sku'] != '*')) {
                    $diagnosticReport = new CovaDiagnosticReport([
                        'product_name' => $row['product_name'] ?? null,
                        'type' => $row['type'] ?? null,
                        'aglc_sku' => $row['aglc_sku'] ?? null,
        ...
        if ($report->province == 'SK' || $report->province == 'Saskatchewan') {
            if ($row['ylc_sku'] != null || $row['product_name'] != null || $row['saskatchewan_barcode_upc'] != null) {
                if (($row['ylc_sku'] != '*')) {
                    $diagnosticReport = new CovaDiagnosticReport([
                        'product_name' => $row['product_name'] ?? null,
                        'type' => $row['type'] ?? null,
        ...
        if ($report->province == 'AB' || $report->province == 'Alberta') {
            if ($row['aglc_sku'] != null || $row['product_name'] != null || $row['manitoba_barcode_upc'] != null) {
                if (($row['aglc_sku'] != '*')) {
                    $diagnosticReport = new CovaDiagnosticReport([
                        'product_name' => $row['product_name'] ?? null,
                        'type' => $row['type'] ?? null,
